<html lang="en"><div class="XTranslate"></div><head>
    <title>CARD CROP</title>
    <!-- for-mobile-apps -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <meta name="csrf-token" content="JguUxWWpA5Qk46OdZOHGxFbbbzcjyQVcKahYWPut">
    ...
    <div id="_bsa_srv-CKYI627U_0"></div><div id="_bsa_srv-CKYI653J_1"></div><div id="_bsa_srv-CKYDL2JN_2"></div></head>
            ...
            <div class="main">
                <div class="w3layouts_main_grid">
                    ...
                    <span class="agileits_grid">
                        <label>documentNumber  <span class="star">*</span></label>
                        <br>
                        <br>
